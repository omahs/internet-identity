...
export type AuthnTemplates = {
  firstTime: {
    slot: TemplateResult;
    useExistingText: string | TemplateResult /** text shown on the button leading to "useExisting" */;
    createAnchorText: string | TemplateResult /** text shown on the button leading to anchor creation */;
  };
  useExisting: {
    slot: TemplateResult;
  };
